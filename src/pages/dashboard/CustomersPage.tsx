...
import type { ICustomerWithStats, IOrder } from "../../types";
...
export default function CustomersPage() {
  const [customers, setCustomers] = useState<ICustomerWithStats[]>([]);
  const [loading, setLoading] = useState(true);
  const [selectedCustomer, setSelectedCustomer] =
    useState<ICustomerWithStats | null>(null);
  ...
  const openEditModal = (customer: ICustomerWithStats) => {
  ...
  const columns = [
    {
      header: "Customer",
      accessor: (customer: ICustomerWithStats) => (
        <div>
